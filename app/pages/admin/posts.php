...
<div class="col-md-12 mx-auto">
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="">
            <textarea row="8" for="floatingInput"  name="content" type="content" class="form-control mb-2" id="floatingInput"placeholder="Content"><?=old_value('content', $row['content'])?></textarea>
      </div>
      <?php if(!empty($errors['content'])):?>
      <div class="text-danger"><?=$errors['content']?></div>
      <?php endif;?>
